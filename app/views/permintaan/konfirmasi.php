            ...
            <?php if ($data['selectedOption'] == 'barang') : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="http://localhost/Tugas_mvc/public/permintaan/konfirmasi" method="post">
                                            ...
                                            <input type="hidden" name="jamP" id="jamP" value="<?= $item['jamP_barang'] ?>">
                                            <input type="hidden" name="jamKP" id="jamKP" value="<?= $item['jamKP_barang'] ?>">
                                            <input type="hidden" name="tglP" id="tglP" value="<?= $item['tanggalP_barang'] ?>">
                ...
                <?php elseif ($data['selectedOption'] == 'ruang') : ?>
                    <div class="form-frame">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="http://localhost/Tugas_mvc/public/permintaan/konfirmasi" method="post">
                                                ...
                                                <input type="hidden" name="jamP" id="jamP" value="<?= $item['jamP_ruang'] ?>">
                                                <input type="hidden" name="jamKP" id="jamKP" value="<?= $item['jamKP_ruang'] ?>">
                                                <input type="hidden" name="tglP" id="tglP" value="<?= $item['tanggalP_ruang'] ?>">
                                                <button class="btn btn-success btn-sm" type="submit">Detail</button>
                                            </form>
                                        </td>
                                    </tr>
                        ...
                        <?php endif; ?>
                    <?php else : ?>
                        <?php include 'konfirmasi_awal.php'; ?>
                    <?php endif; ?>
                    </div>
                </div>
        </div>
