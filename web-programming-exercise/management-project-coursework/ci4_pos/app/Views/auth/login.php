...
<h2 class="text-center py-3 box-title"><?= env('system_name') ?></h2>
            ...
            <div class="container-fluid">
                <form action="<?= base_url('login') ?>" method="POST">
                    ...
                    <div class="d-grid gap-1">
                        <button class="btn rounded-0 bg-gradient" style="background-color: #b22222; ">Login</button>
                                  
                    </div>
                    <div class="mb-3">
...
<style>
    .box-title {
        ...
        /* Tidak ada latar belakang warna */
        width: 500px;
        height: 100px;
        text-align: center;
        font-size: 50px;
