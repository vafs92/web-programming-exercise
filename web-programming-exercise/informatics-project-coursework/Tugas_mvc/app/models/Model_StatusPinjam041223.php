...
class Model_StatusPinjam
{
    ...
    public function cekKodePinjamR($nim)
    {
        $query = "SELECT * FROM pinjam_ruang WHERE nim = :nim ORDER BY kodeP_ruang DESC LIMIT 1";
        $this->db->query($query);
    ...
    {
        $this->db->query('SELECT pb.surat, dpb.kodeP_ruang, m.namaP, m.no_WA, dpb.kodeR, pb.nim, pb.jamP_ruang, pb.jamKP_ruang, pb.tanggalP_ruang, r.namaR, dpb.id_Sekre, dpb.id_Biro, dpb.statusP_ruang FROM detail_pinjam_ruang AS dpb NATURAL JOIN pinjam_ruang AS pb NATURAL JOIN mahasiswa AS m NATURAL JOIN ruang AS r WHERE dpb.statusP_ruang="DIKIRIM" GROUP BY dpb.kodeP_ruang ORDER BY pb.tanggalP_ruang ASC;');
        return $this->db->resultSet();
    }
    ...
    {
        $this->db->query('SELECT pb.surat, dpb.kodeP_barang, m.namaP, m.no_WA, dpb.kodeB, pb.nim, pb.jamP_barang, pb.jamKP_barang, pb.tanggalP_barang, b.namaB, dpb.id_Sekre, dpb.id_Biro, dpb.statusP_barang FROM detail_pinjam_barang AS dpb NATURAL JOIN pinjam_barang AS pb NATURAL JOIN mahasiswa AS m NATURAL JOIN barang AS b WHERE dpb.statusP_barang="DIKIRIM" GROUP BY dpb.kodeP_barang ORDER BY pb.tanggalP_barang ASC;');
        return $this->db->resultSet();
    }
    ...
    public function getAllPinjamBterus()
    {
        ...
        dpb.kodeP_barang, dpb.kodeB, pb.nim, pb.jamP_barang, pb.jamKP_barang, pb.tanggalP_barang, b.namaB, dpb.id_Sekre, dpb.id_Biro, dpb.statusP_barang,
        m.namaP, m.no_WA
        FROM detail_pinjam_barang AS dpb 
        NATURAL JOIN barang AS b 
        NATURAL JOIN pinjam_barang AS pb
        NATURAL JOIN mahasiswa as m
    ...
    {
        $this->db->query('SELECT dpb.ketB, dpb.kodeP_barang, dpb.kodeB, dpb.jmlh, pb.nim, pb.jamP_barang, pb.jamKP_barang, pb.tanggalP_barang,b.namaB, dpb.id_Sekre, dpb.id_Biro, dpb.statusP_barang FROM detail_pinjam_barang AS dpb NATURAL JOIN barang AS b NATURAL JOIN pinjam_barang AS pb WHERE dpb.kodeP_barang = :kodeP AND dpb.statusP_barang="DITERUSKAN";');
        $this->db->bind(':kodeP', $kodeP);
        return $this->db->resultSet();
    }
    ...
    {
        $query = "UPDATE detail_pinjam_barang SET ketB=:ketB, statusP_barang = :statusP, id_Biro= :biro WHERE kodeP_barang = :id AND kodeB = :kode";
    ...
    {
        $this->db->query('SELECT * FROM (SELECT pb.kodeP_barang AS kodeP, pb.nim, pb.jamP_barang AS jamP, pb.jamKP_barang AS jamKP, pb.tanggalP_barang AS tanggalP, b.namaB AS nama, dpb.id_Sekre, dpb.id_Biro, dpb.statusP_barang AS status
                        FROM pinjam_barang AS pb
                        JOIN detail_pinjam_barang AS dpb ON pb.kodeP_barang = dpb.kodeP_barang
                        JOIN barang AS b ON dpb.kodeB = b.kodeB
                        UNION
                        SELECT pr.kodeP_ruang AS kodeP, pr.nim, pr.jamP_ruang AS jamP, pr.jamKP_ruang AS jamKP, pr.tanggalP_ruang AS tanggalP, r.namaR AS nama, dpr.id_Sekre, dpr.id_Biro, dpr.statusP_ruang AS status
                        FROM pinjam_ruang AS pr
                        JOIN detail_pinjam_ruang AS dpr ON pr.kodeP_ruang = dpr.kodeP_ruang
                        JOIN ruang AS r ON dpr.kodeR = r.kodeR) AS rekap_data
    ...
    {
        $this->db->query('SELECT * FROM (SELECT pb.kodeP_barang AS kodeP, pb.nim, pb.jamP_barang AS jamP, pb.jamKP_barang AS jamKP, pb.tanggalP_barang AS tanggalP, b.namaB AS nama, dpb.id_Sekre, dpb.statusP_barang AS status
                    FROM pinjam_barang AS pb
                    JOIN detail_pinjam_barang AS dpb ON pb.kodeP_barang = dpb.kodeP_barang
                    JOIN barang AS b ON dpb.kodeB = b.kodeB
                    WHERE dpb.statusP_barang = "DITERUSKAN"
                    UNION
                    SELECT pr.kodeP_ruang AS kodeP, pr.nim, pr.jamP_ruang AS jamP, pr.jamKP_ruang AS jamKP, pr.tanggalP_ruang AS tanggalP, r.namaR AS nama, dpr.id_Sekre, dpr.statusP_ruang AS status
                    FROM pinjam_ruang AS pr
                    JOIN detail_pinjam_ruang AS dpr ON pr.kodeP_ruang = dpr.kodeP_ruang
                    JOIN ruang AS r ON dpr.kodeR = r.kodeR
