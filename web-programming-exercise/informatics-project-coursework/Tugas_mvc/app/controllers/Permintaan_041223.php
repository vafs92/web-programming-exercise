...
class Permintaan extends Controller
{
    ...
    public function verif()
    {
        ...
        } elseif ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['Detail'])) {
            $option = $_POST['option'];
            $id = $_POST['id'];

            if ($option == 'barang') {
                $data['items_barang'] = $this->model('Model_StatusPinjam')->getAllVerifB($id);
                include 'verif_barang.php';
            } elseif ($option == 'ruang') {
                $data['items_ruang'] = $this->model('Model_StatusPinjam')->getAllVerifR($id);
                include 'verif_ruang.php';
            }
        } else {
    ...
    public function konfirmasi()
    {
        ...
        if ($data['selectedOption'] == 'barang') {
            ...
            if (isset($_POST['id'])) {
                ...
                $data['items_barang'] = $this->model('Model_StatusPinjam')->getAllKonfirmB($id); //diubah
