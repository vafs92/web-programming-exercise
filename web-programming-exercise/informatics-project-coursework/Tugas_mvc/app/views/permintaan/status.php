        ...
        <div class="col-lg-12">
            ...
            <?php if ($data['selectedOption'] == 'barang'): ?>
                <div class="form-frame">
                    ...
                    <table id="example"
                        class="table table-hover table-striped table-light data-table <?= $data['selectedOption'] == 'barang' ? '' : 'hide' ?>"
                ...
                <?php elseif ($data['selectedOption'] == 'ruang'): ?>
                    <div class="form-frame">
                        ...
                        <table id="example"
                            class="table table-hover table-striped table-light data-table <?= $data['selectedOption'] == 'ruang' ? '' : 'hide' ?>"
                            width="100%" cellspacing="0">
                            <thead>
                                <tr class="table-secondary">
                                    <th style="text-align: center;">Kode Pinjam</th>
